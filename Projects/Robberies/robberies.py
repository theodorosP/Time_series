...
plt.title("ACF before transofrmations")
plt.savefig("ACF_before_calcs.png")
plt.show()
sgt.plot_pacf(series1)
plt.title("PACF before transofrmations")
plt.savefig("PACF_before_calcs.png")
plt.show()
...
plt.savefig("Residual_erros.png")
plt.show()

sgt.plot_acf(df_residuals)
plt.title("ACF after transformations")
plt.savefig("ACF_Residual_erros.png")
plt.show()
sgt.plot_pacf(df_residuals)
plt.title("PACF after transformations")
plt.savefig("PACF_Residual_erros.png")
plt.show()
...
plt.ylabel("Years")
plt.savefig("expected_predicted.png")
plt.show()
